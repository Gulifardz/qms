                    ...
                    <div class="container-fluid">
                        ...
                        <div class="bg-white mt-4" id="card-wrapper">
                            ...
                            <el-table :data="table.data" size="large" class="w-100 custom" table-layout="auto" v-loading="table.loading">
                                ...
                                <!-- Checked By -->
                                <el-table-column label="Checked By">
                                    <template #default="scope">
                                        {{ scope.row.checker_id === null ? 'N/A' : scope.row.checker.name }}
                                    </template>
                                </el-table-column>
...
<script>
    export default {
        ...
        methods: {
            getLogs () {
                axios.post('/supermity/logs/list', { ...this.filters, ...this.pagination }).then(response => {
            ...
            viewScanner () {
                window.open('/supermity/scanner', '_blank');
            },
