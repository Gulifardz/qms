                ...
                <el-main class="dashboard__main">
                    <div class="container-fluid">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <el-breadcrumb>
                                <el-breadcrumb-item>
                                    <el-link :underline="false" href="/admin/checkers">Checkers</el-link>
                                </el-breadcrumb-item>
    ...
    export default {
        ...
        methods: {
            ...
            save () {
                ...
                axios.post('/admin/checkers/store', this.form.inputs).then(() => {
                    this.form.loading = false;

                    localStorage.setItem('swal_message', JSON.stringify({ icon: 'success', title: 'Success', text: 'Checker has been added.' }));
                    this.back();
                }).catch(error => {
            ...
            getChecker () {
                const { quarry_id, firstname, lastname, email } = JSON.parse(this.checker);
            ...
            update () {
                ...
                axios.post('/admin/checkers/update/' + this.id, this.form.inputs ).then(() => {
                    this.form.loading = false;

                    localStorage.setItem('swal_message', JSON.stringify({ icon: 'info', title: 'Updated', text: 'Checker has been updated.' }));
                    this.back();
                }).catch(error => {
                    const { status, errors } = error.response.data;
            ...
            back () {
                window.location = '/admin/checkers';
            }
        },
        props: ['id', 'checker']
    }
