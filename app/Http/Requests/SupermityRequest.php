...
class SupermityRequest extends FormRequest
{
    // authorization
    ...
    public function rules() {
        $rules = [
            ...
            'firstname' => 'required',
            'lastname' => 'required',
            'email' => ['required', 'email', 'unique:supermities,email', 'unique:checkers,email', 'unique:companies,email', 'unique:quarries,email']
        ];
